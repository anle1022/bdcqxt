...
public class ServicesLog {
	public static final String EDP = "execution (* kq.qh.service.*.*(..))"  ;

	Logger log = Logger.getLogger("servicesLogger");
    ...
    public void doBefore(JoinPoint jp) {
		...
		sb.append("\r\n    Services[INFO]: ").append(jp.getTarget().getClass().getName()).append(".").append(jp.getSignature().getName())
		.append("\r\n    ==>方法参数：");
    ...
    public void doThrowing(Exception ex) {
		StringBuffer sb = new StringBuffer();
		sb.append("\r\n    Services[ERROR]: ").append(ex.getClass().getName()).append("：").append(ex.getMessage()).append("\r\n");
