	...
	<div class="row-fluid">
		<div class="span8">
			<div class="widget-box">
				<div id="toolbar_item">
						关键词: <input id="keysWord" class="easyui-textbox" name="id"
								style="width: 200px" data-options="">
						类型名称：<input id="typeName" class="easyui-textbox" name="text"
								style="width: 200px" data-options=""
								>
...
<!-- 							<th field="type" width="100px">取号类型</th> -->
<!-- 								<th  width="80px" data-options="field:'type', -->
			...
			<div class="widget-box">
				...
				<div class="easyui-panel" iconCls="icon-plugin_add" title="添加"
					...
					<div class="easyui-panel" id="toolbar_add"
						...
						<div class="fitem" >
							<div  name="qhlx" value="djzh" class="radio"><ins class=""></ins>登记字号</div>
							<div  name="qhlx" value="zszmh"  class="radio"><ins class=""></ins>不动产证书号</div>
							<div  name="qhlx" value="zmh"  class="radio"><ins class=""></ins>不动产证明号</div>
							<div  name="qhlx" value="qt"  class="radio"><ins class="checked"></ins>其他</div>
						</div>
					<form id="addForm" method="post">
						...
						<div class="fitem dept zszmh" >
							<label>登记机构部门</label> <input class="easyui-combobox" id="zs_no" 
								style="width: 200px" data-options="url:'<%=request.getContextPath()%>/dept/findEntityList.do',valueField:'zsNo',textField:'zsNo',formatter:function(val){return val.organization.orgName}">
						</div>
						<div class="fitem dept zmh" >
...
$(function(){
	...
	$("#zs_no").combobox({
		onSelect:function(record){
			...
			if(zsh){
				$("#add_id").textbox("setValue","BDCZSH"+record.zsNo);
			}else{
				$("#add_id").textbox("setValue","BDCZSH"+zsh+record.zsNo);
			}
		}
	});
	$("#zs_no1").combobox({
		onSelect:function(record){
			...
			if(zsh){
				...
				$("#add_id").textbox("setValue","BDCZMH"+zsh+record.zsNo);
			}
		}
	});
}); 
...
<script type="text/javascript">
	...
	function reload(){
		var id = $("#keysWord").textbox("getValue");
