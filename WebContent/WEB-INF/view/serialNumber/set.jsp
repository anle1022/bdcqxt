...
<body class="easyui-layout" data-options="">
	<div id="center" data-options="region:'center'"
		style="width: 800px; height: 100%; overflow: hidden"
		...
		<table id="dg" title="列表" class="easyui-datagrid" style="height: 100%"
	...
	<div data-options="region:'east',fit:false"
		style="width: 400px; height: 98%; margin-left: 0px; margin-bottom: 0px;">
			...
			<form id="updateForm" method="post">
				...
				<div class="fitem">
					<label>年份</label> <input class="easyui-numberspinner" name="year"
						readonly="readonly" data-options="min:1970,max:2999,required:true"
						style="width: 200px">
				</div>
				<div class="fitem">
					<label>取号类型</label> <input class="easyui-combobox" name="type"
						style="width: 200px"
						data-options="required:true,panelHeight:'auto',valueField:'id',textField: 'text',url:'<%=request.getContextPath()%>/numberType/findAll.do'">
				</div>
				<div class="fitem">
		...
		<div class="easyui-panel" iconCls="icon-plugin_add" title="添加"
			style="width: 100%; height: auto;">
			<div class="easyui-panel" id="toolbar_add" style="margin-bottom: 3px">
				<a href="javascript:void(0)" class="easyui-linkbutton"
